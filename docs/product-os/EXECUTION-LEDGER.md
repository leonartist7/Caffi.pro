...
| SPEC-03 | Delivery foundation | Engine, simulator, own drivers and scoped interfaces in draft [PR #87](https://github.com/leonartist7/Caffi.pro/pull/87), implementation `c4ba75d` | 39 unit tests, types, strict lint and docs pass; isolated database/browser CI pending | Not run | Not run | Review; Astra ultra contract approved `ad4b16d`; final Astra xhigh implementation review pending |
