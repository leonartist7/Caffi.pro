...
| SPEC-04 | First courier | Official Uber dossier and sanitized protocol fixtures in draft [PR #86](https://github.com/leonartist7/Caffi.pro/pull/86) | Four offline fixture tests, docs and application CI pass | Blocked: authorized access absent | Not run | Adapter not implemented; commercial/account/service-area and sandbox gates remain |
...
## 2026-09-22 SPEC-04 independent feasibility and fixtures

Branch `codex/spec-04-first-courier` starts at unmerged Phase 2 PR #85 `ef3afe239aba282604670496675ea72e73250a99`, above Product OS #83 and Phase 1 #84. SPEC-03 shared-contract review remains a prerequisite for adapter implementation, not for independent research/fixtures. AC-01: [official Uber Direct dossier](evidence/UBER-DIRECT-2026-09-22.md) records supported protocol observations and exact commercial/idempotency/schema uncertainties. AC-02: synthetic protocol corpus and `npm run test:courier-fixtures` pass four offline Node tests (raw-body signatures, replay limitations, expiry and recovery corpus). No production adapter or shared contract is implemented. AC-03/04 remain blocked by authorized provider sandbox access and approved core contract. Database/browser/provider-sandbox/live checks are not run by this slice. Critical dependency audit, OpenCode supply-chain finding and missing local database/browser evidence from dependencies remain open. Next owner: SPEC-04 implementer after access and contract gates; [handoff](handoffs/HANDOFF-2026-09-22-spec-04.md). Migration: none; rollback: revert fixture/documentation commit; no external effects.

## 2026-09-22 core dependency update

Separate SPEC-03 PR #87 now has independent Astra ultra contract approval at `ad4b16d786eeee59409dc0cbfe52d22f5580da23`, Astra xhigh implementation approval, and full synthetic SQL/browser evidence at `3b07268948e04e79dfaddf45df3e83c7c32eb25c` in [CI 35777014123](https://github.com/leonartist7/Caffi.pro/actions/runs/35777014123). This closes the earlier pending core-review prerequisite. These are simulator/isolated-database results from PR #87, not Uber sandbox evidence or code present in this independent fixture branch. SPEC-04 still requires authorized Uber test credentials/customer account, selected eligible service area and approved account/billing arrangement before adapter implementation; rebase onto the accepted core then. Critical dependency audit and OpenCode finding remain open.
