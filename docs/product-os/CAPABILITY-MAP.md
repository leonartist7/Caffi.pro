...
## 2026-09-24 POS capability update

A reviewable SPEC-05 branch now contains POS mapping, a local simulator, durable submissions and staff recovery. Local type/lint/unit checks pass. Disposable SQL/browser, real POS sandbox and live checks are pending; baseline capability rows above are historical.
