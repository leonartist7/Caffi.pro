...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVncHBiYWF2emV2bWRrYmxuaWltIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI1NDY1NjUsImV4cCI6MjA3ODEyMjU2NX0.TV1fU_XFu2G_uc4bI1kTZPI8oHIKLe0oRjwXK-2H7l8'
...
async function testConnection() {
  ...
  try {
    ...
    if (tenantsError) {
      ...
      tenants.forEach(t => console.log(`   - ${t.business_name} (${t.slug}) - ${t.subscription_status}`))
    }
    ...
    if (usersError) {
      ...
      users.forEach(user => console.log(`   - ${user.full_name}: ${user.loyalty_points} pts (${user.loyalty_tier})`))
    }
